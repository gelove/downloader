// let MD5 = require("md5");
import MD5 from 'https://cdn.jsdelivr.net/npm/md5@2.3.0/+esm'
...
function _0x2d9dba(l) {
  ...
  for (n = 0; n < l.length - 3; n += 4) {
    (u = _0x2efd11(l.charAt(n))),
      (e = _0x2efd11(l.charAt(n + 1))),
      (t = _0x2efd11(l.charAt(n + 2))),
      (r = _0x2efd11(l.charAt(n + 3))),
      (o += String.fromCharCode((u << 2) | (e >>> 4))),
      "=" !== l.charAt(n + 2) && (o += String.fromCharCode(((e << 4) & 240) | ((t >>> 2) & 15))),
