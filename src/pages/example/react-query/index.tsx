              ...
              {data.map((post) => (
                <p key={post.id}>
                  <a
                    ...
                    className="rounded-md px-4 py-2 text-sm font-medium text-green-500 hover:bg-green-500 hover:text-white"
                    href="#"
                    style={
  ...
  return (
    <div>
      <div>
        <a
          href="#"
          className="rounded-md border-2 border-green-500 px-4 py-2 text-sm font-medium text-green-500 hover:bg-green-500 hover:text-white"
          onClick={() => setPostId(-1)}>
          Back
        </a>
      </div>
